...
import { checkTokenBlacklist } from 'auth-middleware-with-redis';
const router = Router();
...
router.post('/register', checkTokenBlacklist, userController.registerUserHandler.bind(userController));
